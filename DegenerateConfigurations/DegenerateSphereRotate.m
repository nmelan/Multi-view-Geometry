function [f1_erMe,f2_erMe,f1_erKr,f2_erKr]=DegenerateSphereRotate(thetain,NL)
...
perm_axis=rand(1,3);
perm_axis=perm_axis/norm(perm_axis);
Pos2=Sph(:,2);
Pos1=Sph(:,1);
dir1=-Sph(:,1);
dir2=-Sph(:,2);
Rrand=rotation_angle_axis(thetain,perm_axis);
dir1=Rrand*dir1;
